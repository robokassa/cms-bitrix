...
if (class_exists("robokassa_payment")) return;

Class robokassa_payment extends CModule
{
	var $MODULE_ID = "robokassa.payment";
	var $MODULE_VERSION;
	...
	{
		CopyDirFiles(
			$_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/robokassa.payment/install/handler', 
	...
	function DoInstall()
	{
		...
		$APPLICATION->IncludeAdminFile(
			...
			$_SERVER['DOCUMENT_ROOT']."/bitrix/modules/robokassa.payment/install/step.php"
		);
	}
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(
			...
			$_SERVER['DOCUMENT_ROOT']."/bitrix/modules/robokassa.payment/install/unstep.php"
		);
	}
	
	function InstallDB()
	{
		RegisterModule("robokassa.payment");
		return true;
	}

	function UnInstallDB()
	{
		UnRegisterModule("robokassa.payment");
		return true;
	}
}
?>